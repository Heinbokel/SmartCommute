...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("location:leaderboardscarpool.php");
}
?>
    ...
    <div class="content">
        <div class="jumbotron" id="leaderboardTitle">
            <h1 class="pageTitle">Commuter Progress: Carpool</h1>
        ...
        <div class='table-responsive'>
            <table class='table-responsive' id="leaderboards">
                <?php include 'populateleaderboardscarpool.php'?>
            </table>
        </div>

        <h1 class="pageTitle">Commutes by Business: Carpool</h1>
        <?php include 'populatebusinessleaderboardscarpool.php';?>
