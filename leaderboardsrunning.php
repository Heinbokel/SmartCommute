...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("location:leaderboardsrunning.php");
}
?>
    ...
    <div class="content">
        <div class="jumbotron" id="leaderboardTitle">
            <h1 class="pageTitle">Commuter Progress: Running</h1>
        ...
        <div class='table-responsive'>
            <table class='table-responsive' id="leaderboards">
                <?php include 'populateleaderboardsrunning.php'?>
            </table>
        </div>

        <h1 class="pageTitle">Commutes by Business: Running</h1>
        <?php include 'populatebusinessleaderboardsrunning.php';?>
