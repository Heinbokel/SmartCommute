...
// If no errors are present, complete signup process.
    if(!$error){
        ...
        mysqli_query($db, "INSERT INTO smartcommuteemmet.User(userID,fName,lName,email,password,DOB,placeEmployed,totalMiles,totalTrips)
        ...
        if($result){
            ...
            $errorType = "Danger!";
            $errorMessage = "The registration attempt failed, please try again.";
        }
    }
