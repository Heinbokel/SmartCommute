...
<head>
    ...
    <title>Michigan Trails Smart Commute: Smart Commute Week</title>
<!-- May 15th-19th -->
...
<div class="content">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <img src="https://imagesus-ssl.homeaway.com/mda01/a610762e-8458-42cf-8d2d-cc17b66726ea.1.10" class="contentPic" alt="Petoskey's Breakwall.">

            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <img src="http://4.bp.blogspot.com/_UFUzmKYSIyU/TKkekOXOYLI/AAAAAAAAAmk/NJUlogVen_s/s1600/bike+trail+south.JPG" class="contentPic" alt="Petoskey's Breakwall.">
